        ...
        <Card className="InnerCard">
            ...
            : 
                <div>
                    ...
                    <Card.Body>
                        {HasCenterPoint ? <Button name="ChangeCP" onClick={handleChange}>Change Center Point</Button>: <Button name="AssignCP" onClick={handleChange}>Assign Center Point</Button>}
                        {EditCenter ? 
                            <div> <br />
                                <Card>
                                    <Card.Header>{AssignCenter ? "Assign Center Point":"Change Center Point"}</Card.Header>
                                    <Card.Body>
                                    <Row>
                                        <Col xs={4}>
                                            <Form.Control
                                ...
                                {MissingInfo ? <Alert variant="warning">All The Needed Info has not been added</Alert>:null}
                                {CenterSetDone ? <Alert variant="success">The Center point has been changed</Alert>:null}
                                {ServerError ? <Alert variant="danger">An Error on the Server has occurred, please try again later</Alert>:null}
                                {NoLocation ? <Alert variant="danger">No Location has been found</Alert>:null}
                                    </Card.Body>
                                </Card>
                            </div>
                            :null}
