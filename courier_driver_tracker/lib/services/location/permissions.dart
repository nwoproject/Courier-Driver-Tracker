...
Future<bool> requestLocationPermission() async {
  ...
  GeolocationStatus geoPermission =
          ...
          child: ListBody(
            children: <Widget>[
              RichText(
                text: TextSpan(
                  text:
                      'Courier Tracker is an application that makes use of your devices ',
                  style: TextStyle(
                    fontSize: 14.0,
              ...
              RichText(
                text: TextSpan(
                  text:
                      'Courier Tracker also runs in the background and requires the location permission ',
                  style: TextStyle(
                    fontSize: 14.0,
                    color: Colors.grey[800],
                  ),
...
class _PermissionsState extends State<Permissions> {
  ...
  locationRequest() async {
    ...
    if (servicesEnabled && locationPermissionGiven && writePermissionGiven) {
      if (loggedIn) {
        _navigateToHome();
      } else {
        _navigateToLogin();
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: ListTile(
                            ...
                            subtitle: RichText(
                              text: TextSpan(
                                text:
                                    'This application uses the devices\' GPS to track the current location. Enable the ',
                                style: TextStyle(
                                  fontSize: 14.0,
                                  color: Colors.grey[800],
                                ),
                        ...
                        Padding(
                          ...
                          child: OutlineButton(
                            child: Text(
                              servicesEnabled ? "ENABLED" : "ENABLE",
                              style: TextStyle(
                                color: servicesEnabled
                                    ? Colors.green
                                    : Colors.blue,
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: ListTile(
                          ...
                          subtitle: RichText(
                            text: TextSpan(
                              text:
                                  'This application runs as a background service. Please select ',
                              style: TextStyle(
                                fontSize: 14.0,
                                color: Colors.grey[800],
                              ),
                              children: <TextSpan>[
                                ...
                                TextSpan(
                                    text:
                                        ' when asked for location permissions to use the application.'),
                              ],
                            ),
                          ),
                        ),
                      ...
                      Padding(
                        ...
                        child: OutlineButton(
                          ...
                          child: Text(
                            locationPermissionGiven ? "ENABLED" : "ENABLE",
                            style: TextStyle(
                              color: locationPermissionGiven
                                  ? Colors.green
                                  : Colors.blue,
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: ListTile(
                          ...
                          subtitle: RichText(
                            text: TextSpan(
                              text:
                                  'This application will need to utilize your storage. Please select ',
                              style: TextStyle(
                                fontSize: 14.0,
                                color: Colors.grey[800],
                              ),
                              children: <TextSpan>[
                                ...
                                TextSpan(
                                    text:
                                        ' when asked for storage permissions.'),
                              ],
                            ),
                          ),
                        ),
                      ...
                      Padding(
                        ...
                        child: OutlineButton(
                          ...
                          splashColor: Colors.green,
                          child: Text(
                            writePermissionGiven ? "ENABLED" : "ENABLE",
                            style: TextStyle(
                              color: writePermissionGiven
                                  ? Colors.green
                                  : Colors.blue,
